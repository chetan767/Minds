...
class ChatAdapter(private val list: MutableList<ChatEvent>, private val mCurrentUser: String,val context: Context ) :
    ...
    override fun onBindViewHolder(holder: RecyclerView.ViewHolder, position: Int) {
        when (val item = list[position]) {
            ...
            is Message -> {
                if (getItemViewType(position) == TEXT_MESSAGE_RECEIVED) {
                    holder.itemView.reccontent.text = item.msg
                    holder.itemView.rectime.text = item.sentAt.formatAsTime()
                    ...
                    holder.itemView.rechighFiveImg.apply {
                ...
                if (getItemViewType(position) == TEXT_MESSAGE_SENT) {
                    ...
                    holder.itemView.setOnLongClickListener {
                        long(holder.itemView.content.text.toString())
